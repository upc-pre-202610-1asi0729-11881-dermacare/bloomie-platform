...
/**
 * Integration event published by the {@code skinAnalysis} bounded context when a preliminary
 * diagnosis has been generated from a completed skin analysis.
 *
 ...
 *
 * @param skinAnalysisId the persistence id of the completed skin analysis
