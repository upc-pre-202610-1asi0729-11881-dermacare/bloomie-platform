...
/**
 * Resource for generating a new personalized routine.
 *
 ...
 */
public record GeneratePersonalizedRoutineResource(Long userId, Long skinProfileId, Long facialScanId, String status) {
}